...
module.exports = class PatientPractitioner {
  ...
  static getSchemaId() {
    return 'PatientPractitioner.json';
  }

  static getSchema() {
    return JSON.parse(fs.readFileSync(path.join(__dirname, '../schemas/PatientPractitioner.json')));
  }
